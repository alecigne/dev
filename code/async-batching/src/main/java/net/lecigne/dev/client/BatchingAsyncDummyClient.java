...
@Singleton
public class BatchingAsyncDummyClient {

  private final HttpClient httpClient;

  @Inject
  public BatchingAsyncDummyClient(@Client("/dummyApi") HttpClient httpClient) {
  ...
  private CompletableFuture<List<Double>> call(List<String> ids, String path) {
    return CompletableFuture.supplyAsync(() -> Lists.partition(ids, 2)
        .parallelStream()
        .flatMap(batch -> {
