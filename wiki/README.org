...
- [[[file:projects/ck0020_java-singleton.org][CK0020]]] =java-singleton= :: The [[https://en.wikipedia.org/wiki/Singleton_pattern][Singleton design pattern]] in
  Java. Part of a [[file:series/design-patterns.org][series on design patterns]].
