...
- [[[file:projects/ck0026_python-binary-search.org][CK0026]]] =python-binary-search= :: [[https://en.wikipedia.org/wiki/Binary_search_algorithm][Binary search]] in Python. Part of
  a [[file:series/algorithms.org][series on algorithms]].
